...
import 'SparkFun_u-blox_GNSS_Arduino_Library.py'
...
class flags:
    def __init__(self, all:int, Bits:bits):
        self.all = all
        self.Bits = Bits
...
class UBX_NAV_POSECEF_moduleQueried_t:
    def __init__(self, all:int, bits:bits2):
        self.all = all
        self.bits = bits
...
class UBX_NAV_POSLLH_data_t:
    def __init__(self, iTOW:int, lon:int, lat:int, height:int, hMSL:int, hAcc:int, vAcc:int):
        self.iTOW = iTOW
        self.lon = lon
        self.lat = lat
        self.height = height
...
class bits3:
    def __init__(self, all:int = 1, lon:int = 1, lat:int = 1, heigth:int = 1, hMSL:int = 1, hAcc:int = 1, vAcc:int = 1):
        self.all = all
        self.lon = lon
        self.lat = lat
        self.height = height
...
class UBX_NAV_POSLLH_moduleQueried_t:
    def __init__(self, all:int, bits:bits3):
        self.all = all
        self.bits = bits

class UBX_NAV_POSLLH_t:
    def __init__(self, automaticFlags:ubxAutomaticFlags,data:UBX_NAV_POSLLH_data_t, callbackPointer:UBX_NAV_POSLLH_data_t, callBackPointerPtr: UBX_NAV_POSLLH_data_t, callbackData:UBX_NAV_POSLLH_data_t):
        self.automaticFlags = automaticFlags
        self.data = data
        self.callBackPointer = callbackPointer
        self.callBackPointerPtr = callBackPointerPtr
...
class UBX_NAV_STATUS_data_t:
    def __init__(self,iTOW,gpsFix, flags:flags2):
